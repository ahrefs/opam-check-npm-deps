...
let _invalid_arg' = invalid_arg

(* Errors *)

let _err_str_formatter = "Format.str_formatter can't be set."
...
let queue ?sep:_ pp_elt = iter Queue.iter pp_elt
...
let id = ref 0
let attr enc dec = incr id; (!id, enc, dec)
